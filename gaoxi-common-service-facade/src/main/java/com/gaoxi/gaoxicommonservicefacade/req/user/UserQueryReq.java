...
import com.gaoxi.gaoxicommonservicefacade.req.QueryReq;

/**
 * @author acong
 * @date 2018年6月15日11:04:11
 * @description 用户查询请求
 */
public class UserQueryReq extends QueryReq {
    ...
    /** 用户类型 {@link com.gaoxi.gaoxicommonservicefacade.enumerate.user.UserTypeEnum}*/
    private Integer userType;
    /** 账号状态 {@link com.gaoxi.gaoxicommonservicefacade.enumerate.user.UserStateEnum}*/
    private  Integer userState;
    /** 用户角色ID*/
    private String roleId;
    /** 根据注册时间排序{@link com.gaoxi.gaoxicommonservicefacade.enumerate.OrderEnum}*/
